...
int main(int argc, char *argv[])
{
	...
	// load shader program
	program = setup_shader(readfile("shader/sun.vs.glsl").c_str(), readfile("shader/fs.glsl").c_str());
	program2 = setup_shader(readfile("shader/earth.vs.glsl").c_str(), readfile("shader/fs.glsl").c_str());
